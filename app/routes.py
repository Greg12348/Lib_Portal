...
from app.forms import (LoginForm, RegistrationForm, EditProfileForm, PostForm,
                       ResetPasswordRequestForm, ResetPasswordForm, MessageForm)
...
def login():
    if current_user.is_authenticated:
        return redirect(url_for('index'))  # 如果已经登陆过，就不必再登陆一次
    form = LoginForm()
    if form.validate_on_submit():
        ...
        return redirect(next_page)  # 登陆成功
